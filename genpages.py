...
DOWNLOADS = '\t\t\t<p>\n' \
            ...
            '\t\t\t\t<a href="https://raw.githubusercontent.com/SMGCommunity/galaxydatabase/main/objectdb.json" download>Whitehole Neo</a><br>\n' \
            '\t\t\t\t<a href="https://raw.githubusercontent.com/SMGCommunity/galaxydatabase/main/objectdb.xml" download>Whitehole v1.7 or older</a>\n' \
            '\t\t\t</p>\n'
...
def __append_config_arguments__(properties: list[GalaxyConfigProperty], has_exclusives: bool, page: str) -> str:
    ...
    for config_property in properties:
        ...
        description = config_property.description.replace('\n', "<br>")
        row = '\t\t\t\t<tr>' \
              ...
              f'<td><p><b>{config_property.name}</b>: {description}</p></td>' \
